  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-black/40 group-hover:bg-black/20 transition-colors duration-500 flex items-center justify-center">
        <div className="bg-brand text-canvas p-4 rounded-full scale-90 opacity-80 group-hover:opacity-100 transition-all duration-500 shadow-[0_0_30px_rgba(255,77,0,0.4)]">

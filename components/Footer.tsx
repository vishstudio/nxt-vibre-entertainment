      ...
      <footer className="bg-canvas relative z-10 pt-0 border-t border-white/10">
                  ...
                  <ScrollReveal>
                     ...
                     <div className="mt-12 flex items-center gap-3">
                        <div className="relative">
                           <div className="w-2 h-2 bg-green-500 rounded-full animate-pulse relative z-10"></div>
                           <div className="absolute inset-0 bg-green-500/50 rounded-full animate-ping"></div>
                        </div>
                        <span className="font-mono text-xs text-green-500/80 uppercase tracking-widest">System Online</span>
                     </div>
                  </ScrollReveal>
               </div>
         ...
         <div className="container mx-auto px-6 py-8 flex flex-col md:flex-row justify-between items-center gap-6 md:gap-4">
            <p className="font-mono text-[10px] text-paint/30 uppercase tracking-widest text-center md:text-left">
               © 2025
               <span className="text-brand hover:text-white transition-colors mx-1">
                  <a href="https://www.vish.studio" target='_blank' rel='noopener noreferrer'>VISH Studio</a>
               </span>.

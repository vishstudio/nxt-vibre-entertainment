...
const Navbar: React.FC = () => {
  ...
  return (
    <>
      <nav 
        className={`fixed top-0 left-0 w-full z-50 transition-all duration-500 opacity-0 animate-nav-entrance ${
          isScrolled 
        ...
        <div className="container mx-auto px-6 md:px-12 flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center gap-12 mix-blend-difference text-white">
             ...
             <button 
                ...
                className="flex items-center gap-3 group pl-8 border-l border-white/30"
             >
      ...
      <div 
        className={`fixed inset-0 z-[60] bg-[#050404] transition-all duration-500 ease-[cubic-bezier(0.86,0,0.07,1)] ${
         ...
         <div className="relative z-10 w-full h-full flex flex-col">
            ...
            <div className="w-full flex justify-between items-center p-6 md:p-12">
                 ...
                 <button 
                    ...
                    className={`group flex items-center gap-4 text-white hover:text-brand transition-all duration-300 ${isOpen ? 'translate-y-0 opacity-100' : '-translate-y-10 opacity-0'}`}
                 >
                    ...
                    {navLinks.map((link, idx) => (
                        ...
                        >
                            ...
                            <div className="relative overflow-hidden">
                                <span 
                                    className={`block font-display font-black text-5xl md:text-8xl leading-none transition-all duration-500 ${
            ...
            <div className={`md:hidden p-6 pb-12 flex justify-between items-end transition-all duration-500 delay-300 ${isOpen ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                <div>
                   ...
                   <p className="text-white">Berlin, DE</p>
                </div>
